...
function EngineeringTabSkeleton() {
  return (
    <div class="flex h-full gap-0">
      {/* 左侧代码树骨架 20% */}
      <div class="w-1/5 border-r border-dls-border p-3 flex flex-col gap-2">
      ...
      {/* 右侧 AI 对话骨架 25% */}
      <div class="w-1/4 border-l border-dls-border p-3 flex flex-col gap-2">
        <For each={[1, 2, 3]}>
          {() => <div class="h-12 bg-gray-4 rounded animate-pulse" />}
        </For>
      </div>
    </div>
  );
