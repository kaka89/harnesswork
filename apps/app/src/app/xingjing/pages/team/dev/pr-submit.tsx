  ...
  return (
    <Show when={task()} fallback={<div style={{ 'text-align': 'center', padding: '32px', color: themeColors.border }}>TASK 未找到</div>}>
      <div style={{ 'max-width': '800px', margin: '0 auto' }}>
        <h2 style={{ 'font-size': '20px', 'font-weight': 600, color: themeColors.text, 'margin-bottom': '16px', 'margin-top': '0', display: 'flex', 'align-items': 'center', gap: '8px' }}>
          <button
        ...
        <div style={{ border: `1px solid ${themeColors.backgroundSecondary}`, 'border-radius': '8px', padding: '16px', 'margin-bottom': '16px', background: themeColors.surface }}>
          ...
          <Show when={!allChecked()}>
            <div style={{ 'margin-top': '12px', padding: '12px', background: themeColors.warningBg, border: `1px solid ${themeColors.warningBorder}`, 'border-radius': '6px', display: 'flex', 'align-items': 'center', gap: '8px', 'font-size': '12px', color: themeColors.warning }}>
