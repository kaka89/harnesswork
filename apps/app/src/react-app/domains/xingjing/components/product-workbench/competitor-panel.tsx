...
export function CompetitorPanel(props: CompetitorPanelProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      {/* Editor Modal */}
      {editor.open && overlayRoot ? createPortal(
      ...
      {/* Compare Drawer */}
      {compareTarget && overlayRoot ? createPortal(
        <div className="absolute right-0 top-0 bottom-0 z-30 flex w-[520px] flex-col border-l border-dls-border bg-dls-surface shadow-xl">
