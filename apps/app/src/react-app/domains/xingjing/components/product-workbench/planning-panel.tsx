...
export function PlanningPanel(props: PlanningPanelProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      {/* Detail Drawer */}
      {detail && overlayRoot ? createPortal(
        <div className="absolute right-0 top-0 bottom-0 z-30 flex w-[420px] flex-col border-l border-dls-border bg-dls-surface shadow-xl">
