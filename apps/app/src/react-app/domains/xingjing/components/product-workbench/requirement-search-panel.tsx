...
export function RequirementSearchPanel(props: RequirementSearchPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* 不再内联渲染 DetailDrawer，已提升至 ProductWorkbenchPage */}
    </div>
  );
}
...
export function DetailDrawer({ item, chatTurns, chatInput, setChatInput, chatSending, onAsk, onClose }: DetailDrawerProps) {
  return (
    <div className="absolute right-0 top-0 bottom-0 z-30 flex w-[480px] flex-col border-l border-dls-border bg-dls-surface shadow-xl">
      {/* header */}
